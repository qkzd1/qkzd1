...
{var b1value=$('.exchangeDiv .b1 input').val();if(b1value==''){msg('请填写您要兑换的数量');return;}});$('.whyDiv .buts li').click(function(event){showWhy($(this).data('num'));});$('.faqDiv .list .arrow').click(function(event){$(this).eq().isUp=!$(this).eq().isUp
console.log($(this).eq())
$(this).toggleClass('up')
